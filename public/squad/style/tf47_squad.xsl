...
-->
	...
	<body>
		...
		<div id="menu">
			...
			<p><em>Web Site : </em><a><xsl:attribute name="href"><xsl:value-of select="concat('http://',/squad/web)"/></xsl:attribute><xsl:value-of select="/squad/web"/></a></p>
		...
		<table class="fiche">
			...
			<tr>
				...
				<td class="nick" ><xsl:value-of select="@nick"/></td>
		...
		<!-- Liste des membres -->
		<div id="footer">
		<p id="copyright">	© The ArmA 3 Wallpaper are the property of Bohemia Interactive (http://www.bistudio.com/) - Available in the website ARMA 3<br/>
